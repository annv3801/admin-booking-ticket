            ...
            <div className="card mb-5 mb-xl-8">
                ...
                <div className="card-header border-0 pt-5">
                    <h3 className="card-title align-items-start flex-column">
                        <span className="card-label fw-bold fs-3 mb-1">View List Theater Management</span>
                    </h3>
                        ...
                        <table className="table align-middle gs-0 gy-4">
                            ...
                            {movies?.data?.data.map((movie) => (
                                <tr>
                                    ...
                                    <td>
                                        <a href="#" className="text-dark fw-bold text-hover-primary d-block mb-1 fs-6">{movie.location}</a>
                                    </td>
                                    <td>
                                        <a href="#" className="text-dark fw-bold text-hover-primary d-block mb-1 fs-6">{movie.phoneNumber}</a>
                                    </td>
                                    <td>
                                        <span className="badge badge-light-success">{movie.status}</span>
                                    </td>
                                    <td className="text-end">
                                        <NavLink to={`/theater/${movie.id}`} className="btn btn-bg-light btn-color-muted btn-active-color-primary btn-sm px-4 me-2">View</NavLink>
