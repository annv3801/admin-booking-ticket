            ...
            <div className="card mb-5 mb-xl-8">
                ...
                <div className="card-header border-0 pt-5">
                    <h3 className="card-title align-items-start flex-column">
                        <span className="card-label fw-bold fs-3 mb-1">View List Category Management</span>
                    </h3>
                    ...
                    <div className="table-responsive">
                        ...
                        <table className="table align-middle gs-0 gy-4">
                            ...
                            <tr className="fw-bold text-muted bg-light">
                                ...
                                <th className="min-w-1000px">Name</th>
                            ...
                            {movies?.data?.data.map((movie) => (
                                <tr>
                                    ...
                                    <td className="text-end">
                                        <NavLink to={`/category/${movie.id}`} className="btn btn-bg-light btn-color-muted btn-active-color-primary btn-sm px-4 me-2">View</NavLink>
